const BacnetPropertyIds = Object.freeze({
  ACKED_TRANSITIONS: 0,
  ACK_REQUIRED: 1,
  ACTION: 2,
  ACTION_TEXT: 3,
  ...
  BLINK_WARN_ENABLE: 18,
  TIME_DELAY: 19,
  CONTROLLED_VARIABLE_REFERENCE: 20,
  CONTROLLED_VARIABLE_UNITS: 21,
  CONTROLLED_VARIABLE_VALUE: 22,
  COV_INCREMENT: 23,
